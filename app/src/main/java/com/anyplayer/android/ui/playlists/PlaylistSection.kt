package com.anyplayer.android.ui.playlists
...
import com.anyplayer.android.ui.TrackSortColumn
import com.anyplayer.android.ui.TrackSortableHeaderRow
import com.anyplayer.android.ui.TrackSourceBadge
import com.anyplayer.android.ui.settings.DuplicateGroupsSection
import com.anyplayer.android.ui.sortTracksWithOriginalIndex
                            ...
                            text = {
                                Column(modifier = Modifier.fillMaxWidth().verticalScroll(rememberScrollState())) {
                                    ...
                                    candidates.forEach { (id, name, sourceType) ->
                                        val normalizedCandidateId = normalizePlaylistId(sourceType, id)
                                        Row(
                                            verticalAlignment = Alignment.CenterVertically,
                                            ...
                                            val isSelected = localSelections.any {
                                                it.sourceType == sourceType &&
                                                    normalizePlaylistId(it.sourceType, it.sourcePlaylistId) == normalizedCandidateId
                                            }
                                            Checkbox(
                                                checked = isSelected,
    ...
    Column(
        ...
        Row(
            ...
            OutlinedTextField(
                ...
                modifier = Modifier.weight(1f).testTag("field_new_standard_playlist_name"),
                singleLine = true
            )
            Button(
                onClick = {
                ...
                modifier = Modifier.testTag("create_standard_playlist_button")
            ) { Text("Create") }
        }
        ...
        Row(
            ...
            OutlinedTextField(
                ...
                modifier = Modifier.weight(1f).testTag("field_new_union_playlist_name"),
                singleLine = true
            )
            Button(
                onClick = {
                ...
                modifier = Modifier.testTag("create_union_playlist_button")
            ) { Text("Create") }
        }
